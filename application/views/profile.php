...
<html xml:lang="zh-CN" xmlns="http://www.w3.org/1999/xhtml" lang="zh-CN"><head>
  ...
  <title>会员资料设置 <?php echo $user->username?>的博客 - 个人博客</title>
...
<table>
	...
	<tr>
		<th>姓名</th>		
		<td>
			<input id="f_username" name="name" size="20" maxlength="20" class="TEXT" value="<?php echo $user->username?>" type="text">
	...
	<tr>
    	<th>性别</th>		
		<td>
			<input type="radio" name="gender" value="男" <?php echo $user->sex=='男'?'checked':false;?> >男
			<input type="radio" name="gender" value="女" <?php echo $user->sex=='女'?'checked':false;?> >女
		</td>	
    </tr>
	<tr>
    	<th class="birthday" alt="<?php echo $user->birthday?>">出生年月</th>		
		<td>
			<select class="year" name="y"><option value="0">--</option><option value="2001">2001</option><option value="2000">2000</option><option value="1999">1999</option><option value="1998">1998</option><option value="1997">1997</option><option value="1996">1996</option><option value="1995">1995</option><option value="1994">1994</option><option value="1993">1993</option><option value="1992">1992</option><option value="1991">1991</option><option value="1990">1990</option><option value="1989">1989</option><option value="1988">1988</option><option value="1987">1987</option><option value="1986">1986</option><option value="1985">1985</option><option value="1984">1984</option><option value="1983">1983</option><option value="1982">1982</option><option value="1981">1981</option><option value="1980">1980</option><option value="1979">1979</option><option value="1978">1978</option><option value="1977">1977</option><option value="1976">1976</option><option value="1975">1975</option><option value="1974">1974</option><option value="1973">1973</option><option value="1972">1972</option><option value="1971">1971</option><option value="1970">1970</option><option value="1969">1969</option><option value="1968">1968</option><option value="1967">1967</option><option value="1966">1966</option><option value="1965">1965</option><option value="1964">1964</option><option value="1963">1963</option><option value="1962">1962</option><option value="1961">1961</option><option value="1960">1960</option><option value="1959">1959</option><option value="1958">1958</option><option value="1957">1957</option><option value="1956">1956</option><option value="1955">1955</option><option value="1954">1954</option><option value="1953">1953</option><option value="1952">1952</option><option value="1951">1951</option><option value="1950">1950</option></select> 年
            <select class="month" name="m"><option selected="selected" value="0">--</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option></select> 月
            <select class="day" name="d"><option selected="selected" value="0">--</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option></select> 日
		</td>	
    </tr>
	<tr>
		<th>居住地区</th>		
...
<select name="city" id="userCity"><option selected="selected" value="哈尔滨">哈尔滨</option><option value="北安">北安</option><option value="大庆">大庆</option><option value="大兴安岭">大兴安岭</option><option value="鹤岗">鹤岗</option><option value="黑河">黑河</option><option value="佳木斯">佳木斯</option><option value="鸡西">鸡西</option><option value="牡丹江">牡丹江</option><option value="齐齐哈尔">齐齐哈尔</option><option value="七台河">七台河</option><option value="双鸭山">双鸭山</option><option value="绥化">绥化</option><option value="伊春">伊春</option></select>
	...
	<tr class="submit">
		<th></th>
		<td>
		<input value="保存修改" class="BUTTON SUBMIT" id="btn-save" type="button">
...
<script>
	$(function(){
		...
		if(birthday != ''){
			...
			$('.day option[value=' + aBirth[2] + ']').attr('selected', true);
		}
