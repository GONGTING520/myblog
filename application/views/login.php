...
<div class="MainForm" id="login_page">	
  <form id="frm_login" action="" method="POST" style="float:left; width:620px;">
    <h2>登录个人博客，如果尚未加入的请点击<a href="welcome/regist">注册新会员</a></h2>
    ...
    <table>
    	...
    	<tr class="buttons">
    		<th>&nbsp;</th>
			<td>
    		<input value="现在登录" id="btn-login" class="BUTTON SUBMIT" type="button" />
			</td>
    	</tr>
